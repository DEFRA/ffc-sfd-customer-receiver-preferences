...
```
variableGroups:
    - ffc-sfd-customer-receiver-preferences-snd1
    - ffc-sfd-customer-receiver-preferences-snd2
    - ffc-sfd-customer-receiver-preferences-snd3
variables:
    - ffc-sfd-customer-receiver-preferences-APPINSIGHTS-CONNECTIONSTRING
```
